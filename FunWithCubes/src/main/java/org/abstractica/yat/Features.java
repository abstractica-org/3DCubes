...
public class Features
{
	...
	private final double diameter1 = 8;
	...
	private final double axleTolerance = 0.1;
	...
	Geometry2D axleProfile(int length)
	{
		List<Vector2D> points = new ArrayList<>();
		points.add(csg.vector2D(0, 0));
		points.add(csg.vector2D(scale * (diameter1 * 0.5+1), 0));
		points.add(csg.vector2D(scale * (diameter1 * 0.5+1), scale * 1));
		points.add(csg.vector2D(scale * diameter1 * 0.5, scale * 1));
		points.add(csg.vector2D(scale * diameter1 * 0.5, scale*(length)*8-2));
		points.add(csg.vector2D(scale * diameter1 * 0.5+0.6, scale*(length)*8-2));
		points.add(csg.vector2D(scale * diameter1 * 0.5+0.6, scale*(length)*8-1.5));
		points.add(csg.vector2D(scale * diameter1 * 0.5-0.5, scale*(length)*8));
		points.add(csg.vector2D(0, scale*(length)*8));
		return csg.polygon2D(points);
	}

	// ***************************************** Helper functions ****************************************

	Geometry3D makeRow(double offSet, double spacing, int xCount, Geometry3D geometry)
	{
	...
	Geometry3D make2DGrid(double offSet, double spacing, int xCount, int yCount, Geometry3D geometry)
	{
