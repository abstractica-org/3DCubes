...
public class SupportPlates
{
	...
	public SupportPlates(JavaCSG csg, double scale, int angularResolution)
	{
		this.csg = csg;
		this.scale = scale;
	...
	public Geometry3D plateOfCorners()
	{
	...
	public static void main(String[] args)
	{
		...
		SupportPlates sp = new SupportPlates(csg, 1.0, 128);
